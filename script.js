function aggiungiCarrello(event){
    ...
    fetch("acquista.php", {method: 'post', body: formData}).then(responseAggiorna);
...
function aggiungiLike(event)
{
 ...
 like = event.currentTarget;
   ...
   // alert(like.dataset.id);
    ...
    fetch("like_post.php", {method: 'post', body: formData}).then(responseAggiorna)
...
function unlikePost(event)
{
 ...
 fetch("unlike_post.php", {method: 'post', body: formData}).then(responseAggiorna)
 .then(function (json){ return updateLikes(json); });
...
function impostalike()
{
    ...
    fetch(richiesta2).then(responseAggiorna).then(caricaLike);
